...
@section('page-desc', 'Update account details for ' . $user->name)
...
<form action="{{ route('admin.users.update', $user) }}" method="POST" class="table-section" style="max-width:600px;">
    ...
    <div style="padding:24px;display:flex;flex-direction:column;gap:20px;">
        ...
        <div class="form-group">
            ...
            <input type="number" name="token_quota_limit" class="form-input" min="1" max="1000000000" step="1" placeholder="Use phase default" value="{{ old('token_quota_limit', $user->token_quota_limit) }}">
            <p class="form-hint">Leave blank to use the default quota for the current phase. A custom value applies to this user every month.</p>
